-- Market Street content admin portal.
...
values
  ...
  (
    ...
    'About',
    '{
      "headline": "About Market Street Wealth Management",
...
create table if not exists public.ms_site_settings (
  ...
  office_name text not null default 'Market Street Wealth Management',
...
insert into public.ms_site_settings (
  ...
  '{"linkedin":"https://www.linkedin.com/company/market-street-wealth-management","facebook":"https://www.facebook.com/mswma"}'::jsonb,
